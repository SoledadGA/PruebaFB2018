...
@Component({
  selector: 'app-area-cinco-dos',
  templateUrl: './area-cinco-dos.component.html',
  styleUrls: ['./area-cinco-dos.component.css']
})
export class AreaCincoDosComponent implements OnInit {
  errores = 0;
  valor = 0;
